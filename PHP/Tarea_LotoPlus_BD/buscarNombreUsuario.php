<?php
$titulo = "Búsqueda por nombre de usuario | LotoPlus";
require('includes/cabecera.php');
require('includes/config.php');
if(isset($_SESSION["usuarioAdmin"]) && isset($_POST["nombreUsuarioBuscar"])){
    $nombreUsuarioBuscado = '%' . strtolower($_POST["nombreUsuarioBuscar"]) . '%';
    ?>
    <section>
        <div class="lista">
            ...
            $sql = "SELECT * FROM usuarios where LOWER(nomusu) LIKE ? GROUP BY idusuario LIMIT $limite, $REGISTROS_PAG";
            mysqli_stmt_prepare($sentencia, $sql);
            mysqli_stmt_bind_param($sentencia, "s", $nombreUsuarioBuscado);
